...
class StudentRegisterDialog(QDialog, StudentRegisterUI):
    ...
    def loadingData(self):
        # Get data of class
        classEntities = self.classRepository.get_all_classes()
        classNames = []
        ...
        scale_img = self.default_img.scaled(self.imgWidget.frameGeometry().width(),
            self.imgWidget.frameGeometry().height(),
            Qt.IgnoreAspectRatio,
            Qt.TransformationMode.SmoothTransformation)
        self.imgWidget.setImage(scale_img)
    ...
    def onClickedSaveBtn(self):
        ...
        # store to db
        idStudent = self.studentIdLineEdit.text()
        ...
        student_entity = StudentEntity(None, self.nameLineEdit.text(), self.studentIdLineEdit.text(), self.birthdayDateEdit.text(), 1, file_path)
    ...
    def checkStudentIdExisted(self, studentId):
        pass
